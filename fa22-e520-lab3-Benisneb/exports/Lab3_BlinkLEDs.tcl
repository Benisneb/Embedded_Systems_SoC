...
#
# Lab3_BlinkLEDs.tcl: Tcl script for re-creating project 'Lab3_BlinkLEDs'
#
# Generated by Vivado on Sat Sep 17 15:32:21 -0700 2022
...
#
# 1. This project restoration tcl script (Lab3_BlinkLEDs.tcl) that was generated.
#
...
set _xil_proj_name_ "Lab3_BlinkLEDs"
...
set script_file "Lab3_BlinkLEDs.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/Lab3_BlinkLEDs"]"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "Blink_LEDs_wrapper" -objects $obj
...
# Proc to create BD Blink_LEDs
proc cr_bd_Blink_LEDs { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name Blink_LEDs
  ...
  set sw_4bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 sw_4bits ]
...
unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#tx#rx#unassigned#unassigned#unassigned#unassigned} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports sw_4bits] [get_bd_intf_pins sw_4bits/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports btns_4bits] [get_bd_intf_pins btns_4bits/GPIO]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins sw_4bits/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins btns_4bits/S_AXI]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins btns_4bits/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins sw_4bits/s_axi_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins btns_4bits/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins sw_4bits/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs btns_4bits/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sw_4bits/S_AXI/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.831851",
   "Default View_TopLeft":"1,-8",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port btns_4bits -pg 1 -lvl 4 -x 1010 -y 80 -defaultsOSRD
preplace port sw_4bits -pg 1 -lvl 4 -x 1010 -y 220 -defaultsOSRD
...
preplace inst sw_4bits -pg 1 -lvl 3 -x 880 -y 220 -defaultsOSRD
preplace inst btns_4bits -pg 1 -lvl 3 -x 880 -y 80 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -x 600 -y 210 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 230 -y 150 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 310 450 350 760
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 440 360 770
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 510 440
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 1 1 N 170
...
preplace netloc axi_interconnect_0_M01_AXI 1 2 1 750 60n
levelinfo -pg 1 0 230 600 880 1010
pagesize -pg 1 -db -bbox -sgen 0 0 1130 520
"
}
...
# End of cr_bd_Blink_LEDs()
cr_bd_Blink_LEDs ""
set_property REGISTERED_WITH_MANAGER "1" [get_files Blink_LEDs.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files Blink_LEDs.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse Blink_LEDs.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/Lab3_BlinkLEDs/Lab3_BlinkLEDs.gen/sources_1/bd/Blink_LEDs/hdl/Blink_LEDs_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse Blink_LEDs.bd] -top]
