...
################################################################
# This is a generated script based on design: Lab6_GPIO_LED_BD
#
...
# source Lab6_GPIO_LED_BD_script.tcl
...
set design_name Lab6_GPIO_LED_BD
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:gpio_ctrl_ip:1.0\
...
proc create_root_design { parentCell } {
  ...
  set gpio_ctrl_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:gpio_ctrl_ip:1.0 gpio_ctrl_ip_0 ]
