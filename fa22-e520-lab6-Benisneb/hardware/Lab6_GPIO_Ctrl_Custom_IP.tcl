...
set obj [get_filesets sources_1]
# Add local files form the original project (-no_copy_sources specified)
set files [list \
...
if { [ get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1 } {
 ...
 set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files - no recurse design_1.bd] -top]
...
set file "Lab6_GPIO_LED_BD/Lab6_GPIO_LED_BD.bd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "Lab6_GPIO_LED_BD_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/Lab6_GPIO_Ctrl_Custom_IP/Lab6_GPIO_Ctrl_Custom_IP.srcs/constrs_1/new/zybo-z7-master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "new/zybo-z7-master.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *new/zybo-z7-master.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/zybo-z7-master.xdc]" -objects $obj
