...
#
# Lab8_Profiling.tcl: Tcl script for re-creating project 'Lab8_Profiling'
#
# Generated by Vivado on Fri Nov 11 14:02:48 PST 2022
...
#
# 1. This project restoration tcl script (Lab8_Profiling.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/../../../../../../JUNK/[file normalize "$origin_dir/fir_ip"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "Lab8_Profiling"
...
set script_file "Lab8_Profiling.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/Lab8_Profiling"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/fir_ip"]" $obj
...
set_property -name "top" -value "Profiling_BD_wrapper" -objects $obj
...
# Proc to create BD Profiling_BD
proc cr_bd_Profiling_BD { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name Profiling_BD
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.57347",
   "Default View_TopLeft":"-22,1",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1040 -y 350 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1040 -y 370 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 230 -y 390 -defaultsOSRD
preplace inst fir_right -pg 1 -lvl 3 -x 900 -y 220 -defaultsOSRD
preplace inst fir_left -pg 1 -lvl 3 -x 900 -y 80 -defaultsOSRD
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 80 440 40 770
...
pagesize -pg 1 -db -bbox -sgen 0 0 1160 500
"
}
...
# End of cr_bd_Profiling_BD()
cr_bd_Profiling_BD ""
set_property REGISTERED_WITH_MANAGER "1" [get_files Profiling_BD.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files Profiling_BD.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse Profiling_BD.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/Lab8_Profiling/Lab8_Profiling.gen/sources_1/bd/Profiling_BD/hdl/Profiling_BD_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse Profiling_BD.bd] -top]
