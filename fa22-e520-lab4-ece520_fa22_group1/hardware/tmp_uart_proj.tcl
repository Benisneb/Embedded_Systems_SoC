...
#
# tmp_uart_proj.tcl: Tcl script for re-creating project 'tmp_uart_proj'
#
# Generated by Vivado on Mon Oct 10 17:12:38 PDT 2022
...
#
# 1. This project restoration tcl script (tmp_uart_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/arianna1/Desktop/ECE520/csun-ece/fa22-e520-lab4-ece520_fa22_group1/hardware/tmp_uart_proj/tmp_uart_proj.srcs/sources_1/bd/tmp_sens_bd/tmp_sens_bd.bd"
#    "/home/arianna1/Desktop/ECE520/csun-ece/fa22-e520-lab4-ece520_fa22_group1/hardware/tmp_uart_proj/tmp_uart_proj.srcs/utils_1/imports/synth_1/tmp_sens_bd_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/arianna1/Desktop/ECE520/csun-ece/fa22-e520-lab4-ece520_fa22_group1/hardware/constr/Zybo-Z7-IO.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/tmp_uart_proj/tmp_uart_proj.srcs/sources_1/bd/tmp_sens_bd/tmp_sens_bd.bd"]"\
 "[file normalize "$origin_dir/tmp_uart_proj/tmp_uart_proj.srcs/utils_1/imports/synth_1/tmp_sens_bd_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/constr/Zybo-Z7-IO.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "tmp_uart_proj"
...
set script_file "tmp_uart_proj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/tmp_uart_proj"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse tmp_sens_bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/tmp_uart_proj/tmp_uart_proj.gen/sources_1/bd/tmp_sens_bd/hdl/tmp_sens_bd_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse tmp_sens_bd.bd] -top]
...
set file "tmp_sens_bd/tmp_sens_bd.bd"
...
set_property -name "top" -value "tmp_sens_bd_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/constr/Zybo-Z7-IO.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/Zybo-Z7-IO.xdc"
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/constr/Zybo-Z7-IO.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/constr/Zybo-Z7-IO.xdc"]" -objects $obj
...
set file "synth_1/tmp_sens_bd_wrapper.dcp"
...
set_property -name "incremental_checkpoint" -value "$proj_dir/tmp_uart_proj.srcs/utils_1/imports/synth_1/tmp_sens_bd_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/tmp_uart_proj.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/tmp_uart_proj.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/tmp_uart_proj.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
