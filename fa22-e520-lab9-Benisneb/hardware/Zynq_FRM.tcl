...
#
# Zynq_FRM.tcl: Tcl script for re-creating project 'Zynq_FRM'
#
# Generated by Vivado on Thu Nov 17 12:56:35 PST 2022
...
#
# 1. This project restoration tcl script (Zynq_FRM.tcl) that was generated.
#
...
set orig_proj_dir "[file normalize "$origin_dir/Zynq_FRM"]"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "zynq_firmware_wrapper" -objects $obj
...
# Proc to create BD zynq_firmware
proc cr_bd_zynq_firmware { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name zynq_firmware
...
\
  ...
  connect_bd_net -net axi_gpio_3_ip2intc_irpt [get_bd_pins axi_gpio_3/ip2intc_irpt] [get_bd_pins xlconcat_0/In3]
  ...
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.18932",
   "Default View_TopLeft":"-10,-82",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1310 -y 330 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1310 -y 350 -defaultsOSRD
preplace port btns_4bits -pg 1 -lvl 5 -x 1310 -y 70 -defaultsOSRD
preplace port sws_4bits -pg 1 -lvl 5 -x 1310 -y 230 -defaultsOSRD
preplace port leds_4bits -pg 1 -lvl 5 -x 1310 -y 420 -defaultsOSRD
preplace port rgb_led -pg 1 -lvl 5 -x 1310 -y 580 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -x 440 -y 380 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 4 -x 1160 -y 80 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 4 -x 1160 -y 240 -defaultsOSRD
preplace inst axi_gpio_2 -pg 1 -lvl 4 -x 1160 -y 430 -defaultsOSRD
preplace inst axi_gpio_3 -pg 1 -lvl 4 -x 1160 -y 590 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 820 -y 540 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 2 -x 440 -y 610 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -x 130 -y 390 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 1 3 230 500 650 730 1010
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 240 490 640
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 2 2 660 720 1020
preplace netloc xlconcat_0_dout 1 1 1 N 390
preplace netloc axi_gpio_0_ip2intc_irpt 1 0 5 10 160 NJ 160 NJ 160 NJ 160 1290
preplace netloc axi_gpio_1_ip2intc_irpt 1 0 5 20 260 NJ 260 NJ 260 1000J 320 1290
preplace netloc axi_gpio_2_ip2intc_irpt 1 0 5 30 270 NJ 270 NJ 270 980J 340 1290
preplace netloc axi_gpio_3_ip2intc_irpt 1 0 5 30 740 NJ 740 NJ 740 NJ 740 1290
preplace netloc processing_system7_0_DDR 1 2 3 NJ 330 NJ 330 NJ
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ 350 NJ 350 NJ
preplace netloc axi_gpio_0_GPIO 1 4 1 NJ 70
preplace netloc processing_system7_0_M_AXI_GP0 1 2 1 660 390n
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 1 970 60n
preplace netloc axi_gpio_1_GPIO 1 4 1 NJ 230
preplace netloc ps7_0_axi_periph_M01_AXI 1 3 1 990 220n
preplace netloc axi_gpio_2_GPIO 1 4 1 NJ 420
preplace netloc ps7_0_axi_periph_M02_AXI 1 3 1 1030 410n
preplace netloc axi_gpio_3_GPIO 1 4 1 NJ 580
preplace netloc ps7_0_axi_periph_M03_AXI 1 3 1 N 570
levelinfo -pg 1 -10 130 440 820 1160 1310
pagesize -pg 1 -db -bbox -sgen -10 0 1440 750
"
}
...
# End of cr_bd_zynq_firmware()
cr_bd_zynq_firmware ""
set_property REGISTERED_WITH_MANAGER "1" [get_files zynq_firmware.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zynq_firmware.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse zynq_firmware.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/Zynq_FRM/Zynq_FRM.gen/sources_1/bd/zynq_firmware/hdl/zynq_firmware_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse zynq_firmware.bd] -top]
